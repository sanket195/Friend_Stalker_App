...
/**
 * Created by btril on 08/02/17.
 */

public class GPSTrackingActivity extends Service implements LocationListener {
...
//https://stackoverflow.com/questions/15997079/getlastknownlocation-always-return-null-after-i-re-install-the-apk-file-via-ecli
    ...
    public void stopUsingGPS() {
        if (locationManager != null) {
            ...
            locationManager.removeUpdates(GPSTrackingActivity.this);
        }
    }
